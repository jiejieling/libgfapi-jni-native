...
struct dirent *getdirentFields(JNIEnv *env, jobject lpObject, struct dirent *lpStruct)
{
	...
	lpStruct->d_ino = (__ino_t)(*env)->GetLongField(env, lpObject, direntFc.d_ino);
	lpStruct->d_off = (__off_t)(*env)->GetLongField(env, lpObject, direntFc.d_off);
...
struct statvfs *getstatvfsFields(JNIEnv *env, jobject lpObject, struct statvfs *lpStruct)
{
	...
	lpStruct->f_blocks = (__fsblkcnt_t)(*env)->GetLongField(env, lpObject, statvfsFc.f_blocks);
	lpStruct->f_bfree = (__fsblkcnt_t)(*env)->GetLongField(env, lpObject, statvfsFc.f_bfree);
	lpStruct->f_bavail = (__fsblkcnt_t)(*env)->GetLongField(env, lpObject, statvfsFc.f_bavail);
	lpStruct->f_files = (__fsfilcnt_t)(*env)->GetLongField(env, lpObject, statvfsFc.f_files);
	lpStruct->f_ffree = (__fsfilcnt_t)(*env)->GetLongField(env, lpObject, statvfsFc.f_ffree);
	lpStruct->f_favail = (__fsfilcnt_t)(*env)->GetLongField(env, lpObject, statvfsFc.f_favail);
